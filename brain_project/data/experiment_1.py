...
# ------------------------------------------------------------
# 1. Load data (HCP sample, n=977 after exclusions)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 2. Reconstruct full correlation matrices (oracle‑shrunk + normalized)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 3. Functional network parcellation (7 networks, Schaefer style)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 4. Top / bottom 10% groups based on PMAT_A_CR
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 5. Fréchet means under the Euclidean‑Cholesky metric
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 6. Difference matrix (Figure 4C) – sorted by functional network
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 7. Brain surface visualizations (Figure 4A & 4B style)
...
def plot_brain_surface(mat, title, filename, threshold_percent=98):
    """Create an interactive HTML brain surface with thresholded connectome."""
...
# Interactive HTML (open in browser) – shows real cortical surface
...
# Also save static glass brain PNGs (optional, but useful for quick checks)
...
# ------------------------------------------------------------
# 8. Predictive modeling – 80/20 train/test split
# ------------------------------------------------------------
